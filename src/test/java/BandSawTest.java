...
public class BandSawTest {
    ...
    void testToString() {
        ...
        assertEquals(expectedString, bandSaw.toString());
    }

    @Test
    void testGetRemainingWorkTime() {
        BandSaw bandSaw = new BandSaw(10, "Brand", 100, 50, 10.5, true);
        final double TrueRemainingWorkTime = 0.0;
        assertEquals(TrueRemainingWorkTime, bandSaw.getRemainingWorkTime(), 0.05);
    }
